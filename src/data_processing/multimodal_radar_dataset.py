...
class radar_dataset_multimodal(Dataset):
    def __init__(self, folderloc_radar, folderloc_env , total, list_length=10, min_list_length = 10):
        min_list_length = list_length
        
        self.data = load_data_multimodal(folder_path_radar=folderloc_radar,folder_path_env=folderloc_env, total=total)
    ...
    def __getitem__(self, idx):
        ...
        # sample: [T, C, H, W] where C=5 (radar + env channels)
