...
4. Set `RUN_TRAINING = True` only when ready to train, then Run All. Preparation may be slow the first time; training resumes from `latest.pt` after interruption.
